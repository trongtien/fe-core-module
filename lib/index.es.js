...
var Input = function (props) {
    ...
    return (jsxs(CssInput, __assign({ fullWidth: fullWidth, className: inputClassName, id: id, disabled: disabled, sx: sx }, { children: [!!label &&
...
export { Button, Input$1 as Input, Select };
